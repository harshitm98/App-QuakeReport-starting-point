...
public class EarthquakeActivity extends AppCompatActivity {
    ...
    private class EarthquakeAsynTask extends AsyncTask<String, Void, ArrayList<EarthquakeDetails>> {

        @Override
        protected ArrayList<EarthquakeDetails> doInBackground(String... url) {
            // Create a list of earthquake locations.
            final ArrayList<EarthquakeDetails> earthquakes = QueryUtils.fetchEarthquakeData(url[0]);
            return earthquakes;
        }

        protected void onPostExecute(ArrayList<EarthquakeDetails> earthquakes) {
