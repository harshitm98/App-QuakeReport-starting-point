...
public final class QueryUtils {
    ...
    /**
     * Query the USGS dataset and returns an {@link ArrayList<EarthquakeDetails>} that represents lists of
     * earthquakes.
     */
    public static ArrayList<EarthquakeDetails> fetchEarthquakeData(String requestUrl) {
        ...
        ArrayList<EarthquakeDetails> earthquake = extractJsonResponse(jsonResponse);

        // Return the {@Link ArrayList<EarthquakeDetails>}
        return earthquake;
    }
     ...
     */
    public static ArrayList<EarthquakeDetails> extractJsonResponse(String JsonResponse) {
        ...
        try {
            ...
            for(int i = 0; i<features.length();i++){
                ...
                earthquakes.add(new EarthquakeDetails(output,place,time,url));
            }
