    ...
    public static ArrayList<EarthquakeDetails> extractEarthquakes() {
        ...
        try {
            ...
            for(int i = 0; i<features.length();i++){
                ...
                earthquakes.add(new EarthquakeDetails(output,place,time));
            }
